...
<div class="bgded overlay" style="background-image:url('images/achtergrnd.jpg');"> 
    ...
    <header id="header" class="hoc clear"> 
      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li><a class="drop" href="pages/sportartikel.html">Articles</a>
            <ul>
              <li><a href="pages/sportartikel.html">Economie</a></li>
              <li><a href="pages/sportartikel.html">Sport</a></li>
              <li><a href="pages/sportartikel.html">Oorlog</a></li>
              <li><a href="pages/sportartikel.html">Politiek</a></li>
            </ul>
          </li>
  ...
  <div id="pageintro" class="hoc clear">
    <article> 
      ...
      <p class="font-x1 uppercase bold"><a href="pages/sportartikel.html">Bekijk hier artikels</a></p>
      <footer>
        <ul class="nospace inline pushright">
          <li><a class="btn" href="login/index.php">Login</a></li>
          <li><a class="btn inverse" href="login/register.php">Registration</a></li>
        </ul>
      </footer>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    ...
    <p class="fl_left">Copyright &copy; 2016 - All Rights Reserved - <a href="#">Thor Boonaert</a></p>
